...
import { Layout, FileSpreadsheet, Sparkles, AlertCircle, Link as LinkIcon, Loader2, Settings, Key, X, Save, BookOpen, Search } from 'lucide-react';
...
function App() {
  ...
  const [viewMode, setViewMode] = useState<'analyzer' | 'library'>('analyzer');
      ...
      <header className="border-b border-slate-100 bg-white/80 backdrop-blur-md sticky top-0 z-50">
        <div className="max-w-5xl mx-auto px-4 h-16 flex items-center justify-between">
          ...
          <div className="flex items-center gap-1 bg-slate-100/80 p-1 rounded-lg">
            ...
            >
              <span className="flex items-center gap-2"><Layout className="w-4 h-4" /> Phân Tích</span>
            </button>
            <button
            ...
            >
              <span className="flex items-center gap-2"><BookOpen className="w-4 h-4" /> Thư Viện Hàm</span>
            </button>
          </div>
